...
var App = function() {
    ...
    var cursorTrack = function() {
        ...
        $('body').append('<img id="cursor" src="http://localhost.com/GSP/clients/nintendo/coin-orgy/v1/images/cursor.png" alt="cursor" />');
...
if(typeof jQuery == 'undefined') {
    ...
    if (!document.getElementById('coins-style')) {
        ...
        if (objHead[0]) {
            ...
            objCSS.href = '//localhost.com/GSP/clients/nintendo/coin-orgy/v1/css/coins.css';
